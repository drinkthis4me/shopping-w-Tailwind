<template>
  <div>
    <div v-show="bannerMsg.length > 0" class="mx-auto mt-5">
      <PageMsgBanner :msg="bannerMsg" :status="'success'" />
    </div>

    <div class="w-[530px] overflow-hidden rounded-lg bg-white shadow-2xl">
...
function onSubmitClick() {
  ...
  bannerMsg.value = 'Recovery email sent. Please check your inbox.'
  emit('submit')
}
</script>
