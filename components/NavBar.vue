          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <NuxtLink to="/cart" v-else>
              <div class="dropdown dropdown-end dropdown-hover">
                ...
                <div
                  tabindex="0"
                  class="dropdown-content rounded bg-base-100 mt-3 w-52 shadow ring-2 ring-black ring-opacity-5">
                  <div class="card-body">
                    <span class="text-lg font-bold">{{ cartStore.numberOfItems }} Items</span>
                    <span class="text-info">Subtotal: ${{ cartStore.subtotal.toLocaleString() }}</span>
                  </div>
                </div>
              </div>
            </NuxtLink>
